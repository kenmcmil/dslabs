...
public final class Test extends BaseJUnitTest {
    ...
    private static final class TokenParser implements
    ...
    static StateGeneratorBuilder builder() {
        ...
        builder.serverSupplier(a -> new TokenServer(a,a.equals(server(1)),
                                                    a.equals(server(1)) ? server(2) :
                                                    a.equals(server(2)) ? server(3) :
                                                    server(1)));
        builder.clientSupplier(a -> new TokenClient(a,
    ...
    public void test01BasicToken() throws InterruptedException {
    ...
    public void test02BasicToken() throws InterruptedException {
